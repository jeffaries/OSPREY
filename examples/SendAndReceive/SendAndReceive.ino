...
void loop() {
  ...
  if (millis() - lastprint > 10000) {
    ...
    #endif
    #ifdef LCD
      lcd.setCursor(0,0);  lcd.printstr("Received :      ");
      lcd.setCursor(11,0); lcd.print(count_receive);
      lcd.setCursor(0,1);  lcd.printstr("Sent     :      "); 
      lcd.setCursor(11,1); lcd.print(count_send);
    #endif    
